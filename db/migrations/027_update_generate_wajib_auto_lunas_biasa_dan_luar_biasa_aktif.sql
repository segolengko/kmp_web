...
BEGIN
    ...
    VALUES (
        ...
        0,
        'PROSES',
        'Generate simpanan wajib bulanan dengan auto lunas untuk segmen aktif dan manual untuk luar biasa pasif.',
        p_dibuat_oleh
    )
    ...
    SET
        ...
        catatan = FORMAT(
            'Generate simpanan wajib selesai. Auto lunas segmen aktif: %s. Tagihan manual luar biasa pasif: %s. Anggota tanpa nominal: %s.',
            v_total_tagihan_auto_lunas,
            v_total_tagihan_manual,
